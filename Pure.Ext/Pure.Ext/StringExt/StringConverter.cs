...
public static class StringConverter
{
    ...
    #endregion SQL Server数据类型字符串转换为SqlDbType类型
    ...
    #endregion string转换为System.Type
    ...
    #endregion 根据类全名在当前程序集里获取System.Type
