...
using System.Text;
    ...
    public static class DateTimeExtensions
    {
      ...
      /// <returns></returns>
        ...
        {
            long ticks = (timeStamp * 0x989680L) + 0x89f7ff5f7b58000L;
            DateTime time = new DateTime(ticks);
            double totalSeconds = TimeZone.CurrentTimeZone.GetUtcOffset(time).TotalSeconds;
            return time.AddSeconds(totalSeconds);
        }
        ...
        public static string ToStringOfWeekChinese(this DateTime dateSrc)
        {
            ...
            switch (day)
            {
                case DayOfWeek.Friday: strTMP = "星期五";
                    break;
                case DayOfWeek.Monday: strTMP = "星期一";
                    break;
                case DayOfWeek.Saturday: strTMP = "星期六";
                    break;
                case DayOfWeek.Sunday: strTMP = "星期日";
                    break;
                case DayOfWeek.Thursday: strTMP = "星期四";
                    break;
                case DayOfWeek.Tuesday: strTMP = "星期二";
                    break;
                case DayOfWeek.Wednesday: strTMP = "星期三";
                    break;
                default: strTMP = "星期一";
                    break;
            }
        ...
        public static int DayInWeek(this DateTime dateSrc)
        {
            ...
            switch (day)
            {
                case DayOfWeek.Friday: iTMP = 5;
                    break;
                case DayOfWeek.Monday: iTMP = 1;
                    break;
                case DayOfWeek.Saturday: iTMP = 6;
                    break;
                case DayOfWeek.Sunday: iTMP = 7;
                    break;
                case DayOfWeek.Thursday: iTMP = 4;
                    break;
                case DayOfWeek.Tuesday: iTMP = 2;
                    break;
                case DayOfWeek.Wednesday: iTMP = 3;
                    break;
                default: iTMP = 1;
                    break;
            }
