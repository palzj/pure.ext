...
public static class ExpressionExtensions
{
    ...
    private static void ConvertExpressions(ref Expression expression1, ref Expression expression2)
    {
        ...
        {
            bool flag = expression1.Type.IsNullableType();
            bool flag2 = expression2.Type.IsNullableType();
            if ((flag || flag2) && (expression1.Type.GetNonNullableType() == expression2.Type.GetNonNullableType()))
            {
                if (!flag)
                {
